...
type Options struct {
	...
	Depth              int  `short:"D" long:"depth" description:"When used with recurse, only recurses as deep as argued. Exclusive recurse only recurses items deeper than argued."`
